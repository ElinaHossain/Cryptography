...
Zip name for submission:
Firstname_Lastname_EncryptProject.zip

Required items to include:
- All project files listed above
- At least one sample input file and at least one output file (provided)
